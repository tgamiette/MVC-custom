...
class ImageManager extends BaseManager
{
    ...
    public function add(Image $image): bool
    {
        ...
        $request->bindValue(':nom', $image->getTitle(), \PDO::PARAM_STR);
        $request->bindValue(':taille', $image->getContent(), \PDO::PARAM_INT);
        $request->bindValue(':type', $image->getAuthor(), \PDO::PARAM_STR);
        $request->bindValue(':desc', $image->getPublishedAt(), \PDO::PARAM_STR);
        $request->bindValue(':blob', $image->getPublishedAt(), \PDO::PARAM_INT);
